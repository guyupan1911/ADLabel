...
class LosslessMapMatrix {
 public:
  ...
  virtual const LosslessMapCell* Find(unsigned int row,
                                      unsigned int col) const = 0;
  virtual LosslessMapCell& GetOrCreate(unsigned int row, unsigned int col) = 0;

  using Visitor = std::function<void(unsigned int row, unsigned int col,
                                     const LosslessMapCell&)>;
...
class DenseLosslessMapMatrix : public LosslessMapMatrix {
 public:
  ...
  const LosslessMapCell* Find(unsigned int row,
